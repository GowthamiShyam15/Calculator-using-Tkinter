...
btn_div = Button(mw, text='/', padx=38, pady=10, font=('Arial', 14), command=lambda: cal('div'))
btn_mul = Button(mw, text='*', padx=38, pady=10, font=('Arial', 14), command=lambda: cal('mul'))
btn_add = Button(mw, text='+', padx=38, pady=10, font=('Arial', 14), command=lambda: cal('add'))
btn_sub = Button(mw, text='-', padx=38, pady=10, font=('Arial', 14), command=lambda: cal('sub'))
